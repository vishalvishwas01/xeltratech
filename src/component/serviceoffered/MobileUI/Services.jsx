...
function Services() {
    const data =[
        ...
        },
        {
            ...
            para:"Designing interactive and user-friendly mobile app prototypes to visualize, test, and refine your app experience.",
        },
        {
            logo:logo3,
            heading:"VISUAL DESIGN",
            para:"Creating stunning and user-centric visual designs that enhance aesthetics, usability, and brand identity seamlessly.",
        },
        {
            logo:logo4,
            heading:"MOBILE (UX) DESIGNING",
            para:"Crafting intuitive and user-friendly mobile UX designs that enhance engagement, usability, and overall experience.",
        },
    ]
  return (
    <>
